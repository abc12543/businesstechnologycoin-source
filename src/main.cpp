...
#if defined(NDEBUG)
# error "businesstechnologycoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xf40da1af72f1045bbc0019c07357d7d3319c4d07a879e0101e361555b75dbe3a");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // businesstechnologycoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "businesstechnologycoin Signed Message:\n";
...
{
    // businesstechnologycoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // businesstechnologycoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // businesstechnologycoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1464883506, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04a9d831ac6e1da2f1528b21e26d921527677f8670280930fb2af7e62bf50d8b28180dffa7348b7aa12f00475ff932ebaa71ccfd205acb34e0ea3e659963606db2") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1464883506;
        ...
        assert(block.hashMerkleRoot == uint256("0x0a4b75d5f0788db9fb0cef77da2560f866f390d3c01e57e670d640cf6f61dee5"));
...
unsigned char pchMessageStart[4] = { 0x17, 0xb0, 0xdb, 0xc9 }; // businesstechnologycoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    //// debug print
    printf("businesstechnologycoinMiner:\n");
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("businesstechnologycoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("businesstechnologycoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static businesstechnologycoinMiner(CWallet *pwallet)
{
    printf("businesstechnologycoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("businesstechnologycoin-miner");
    ...
    try { loop {
        ...
        printf("Running businesstechnologycoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("businesstechnologycoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&businesstechnologycoinMiner, pwallet));
}
