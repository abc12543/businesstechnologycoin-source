TEMPLATE = app
TARGET = businesstechnologycoin-qt
macx:TARGET = "businesstechnologycoin-Qt"
VERSION = 0.8.7.5
...
QT += testlib
TARGET = businesstechnologycoin-qt_test
...
macx:ICON = src/qt/res/icons/businesstechnologycoin.icns
